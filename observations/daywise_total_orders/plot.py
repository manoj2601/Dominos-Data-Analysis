...
df = pd.read_excel(f'./../../data-sept-14/Item-wise-details-{city}-17-23-Dec-2021.xlsx')
l = df.to_dict('records')

df2 = pd.read_excel(f'./../../data-sept-14/Item-wise-details-{city}-24-31-Dec-2021.xlsx')
...
orders = []
for dic in l:
	if(dic['Order_Date'] == '18/12/2021 00:00:00'):
		orders.append(dic)
...
for order in orders:
	dt = datetime.datetime.strptime(order['Actual_Order_Date'], "%d/%m/%Y %H:%M:%S")
	i = getTimeIndex(dt)
	finalDict[i] += 1
...
orders = []
for dic in l:
	if(dic['Order_Date'] == '19/12/2021 00:00:00'):
		orders.append(dic)
...
orders = []
for dic in l:
	if(dic['Order_Date'] == '20/12/2021 00:00:00'):
		orders.append(dic)
...
orders = []
for dic in l2:
	if(dic['Order_Date'] == '25/12/2021 00:00:00'):
		orders.append(dic)
...
orders = []
for dic in l2:
	if(dic['Order_Date'] == '31/12/2021 00:00:00'):
		orders.append(dic)
